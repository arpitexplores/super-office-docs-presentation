...
5. Rename the extracted folder from `super-office-docs-presentation-main` to `super-office-docs-presentation`.
6. Copy the renamed `super-office-docs-presentation` folder into your agent's skills directory.
...
This repository is the `super-office-docs-presentation` skill. Keep the full `super-office-docs-presentation` folder together when installing it.
